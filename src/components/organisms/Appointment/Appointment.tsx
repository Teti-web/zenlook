  ...
  return (
    <section className="flex flex-col gap-4 md:gap-10" ref={ref}>
      <div className="flex w-full flex-col gap-4 md:flex-row md:gap-0">
        <div className="md:min-w-[25.78vw] lg:min-w-[463px]">{label && <Label {...label} />}</div>
        <motion.div
        ...
        >
          <Heading {...title} className="text-gradient-red text-left leading-none md:max-w-[260px] lg:max-w-[660px]" />
